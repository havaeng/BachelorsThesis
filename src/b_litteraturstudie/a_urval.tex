...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Behandlar SFERA-standarden eller annat liknande kommunikationsprotokoll mellan lokförare och tågklarerare \emph{eller} behandlar kommunikation mellan lokförare och tågklarerare \emph{eller} behandlar gamification i en C-DAS-kontext
    \end{enumerate}
