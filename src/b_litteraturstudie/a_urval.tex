...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Behandlar SFERA-standarden eller annat liknande kommunikationsprotokoll mellan lokförare och tågklarerare \emph{eller} behandlar data som tillhandahålles av ett TMS
    \end{enumerate}
