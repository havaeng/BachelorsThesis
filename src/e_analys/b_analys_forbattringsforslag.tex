...
Om överskriften är i blått är hela figuren ett förbättringsförslag.
...
Datastrukturen för plattformsbehovsmeddelande illustreras i figur~\ref{tab:plattformsbehov} som del av meddelandet Train message.
\begin{table}[hbt!]
    \centering
    \begin{tabular}{|l|l|}
        \hline
