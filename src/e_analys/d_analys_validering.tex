\subsection{Validering av förbättringsförslag}\label{subsec:validering}
Förbättringsförslagen från avsnitt~\ref{subsec:sfera-utokat} utvärderades i en andra omgång intervjuer med scenariobeskrivningar för att validera de nya datamodellernas faktiska värde.
En sammanställning av scenariobeskrivningar och svar för intervjuerna i avsnitt finns i bilaga B.
...
Någon jämförde det med \lq{}den berömda, telefonstyrda signalen\rq{} vilket avser när tågklarerar-en får ett samtal, ser att tåget står vi en stoppsignal och därför väljer att lägga körbesked i signalen istället för att ens svara.
