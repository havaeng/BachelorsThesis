...
\paragraph{}
\hspace{-11}Under dynamiken och spelmekanikerna ligger komponenter som är de grundläggande element vilka slutligen möjliggör gamification.
Några viktiga är prestationsmilstopar (eng. \lq{}achievements\rq{}) som är tydligt uppsatta mål~\cite{Cwil2018}.
...
Vidare finns många andra komponenter såsom progressionsbaserat upplåsbart innehåll, topplistor, poäng, uppdrag, sociala grupper/team, kosmetiska variationer för avatarer (skins), virtuellt gods och så vidare~\cite{Bae2014, Cwil2018}.
\paragraph{}
...
Det gäller i synnerhet negativ feedback men även positiv dito då inte bara negativ feedback skulle kunna leda till känslan av att vara övervakad.
Påståendet styrks även i uttalanden från flera respondenter i denna studies intervjuer.
...
Det är som tidigare nämnt viktigt att management inte använder statistiken för att följa upp eller mäta lokförarnas färdigheter~\cite{Bae2014}.
