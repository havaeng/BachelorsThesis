\subsection{Dokumentanalys}\label{subsec:dokumentanalys}
...
\subsubsection{Datauppställning}
...
\paragraph{}
\hspace{-11}En journey profile (se figur~\ref{tab:jp}) består av flera delar.
Tågfärdens unika referens-ID\footnote{Vanligtvis ett nummer, som är unikt för innevarande trafikdygn.}~och information om tågets fysiska egenskaper (train characteristics, TC).
...
\begin{table}[hbt!]
    ...
    \label{tab:jp}
\end{table}
Status report (se figur~\ref{tab:sr}) är sättet på vilket C-DAS-OB kan skicka information till TMS\@.
Det består av tågets position i förhållande till referenspunkter från tilldelad SP (som del av JP), innevarande hastighet, senast passerade trafikplats och prognos för ankomst till nästa trafikplats, aktuell JP, förväntad energikonsumtion och -återmatning (elbroms) för kommande minuter samt statusmeddelanden.
Lokförare kan även rapportera in om förändringar i adhesionsförhållanden.
...
\begin{table}
    ...
    \begin{tabular}{|l|l|l|}
        ...
        - Uppehåll\footnote{Plats för exempelvis resandeutbyte eller tågmöte.} & - Unikt ID för aktuell bana & - Tunnel \\
...
\paragraph{}
\hspace{-11}För den polska applikationen introducerades poängbaserade gamification-element stegvis i fyra olika faser med 2--3 månaders mellanrum så att förarna inte skulle bli överväldigare och lära sig systemet i en god takt.
...
\paragraph{}
\hspace{-11}Den första fasen syftade till att synliggöra för förarna hur energieffektivt de körde genom att mäta hur mycket effekt från kontaktledningen som använts och återge detta så snabbt som möjligt.
...
\paragraph{}
\hspace{-11}Andra fasen syftade till att introducera gamification-moment där förarna kunde jämföra sig med varandra.
...
\paragraph{}
\hspace{-11}I tredje fasen låg fokus på att stärka förarnas intrinsiska motivation genom laganda och samarbete.
...
\paragraph{}
\hspace{-11}För fjärde och sista fasen låg fokus på att aktivera de bästa förarna på ett sätt så att de skulle få ett fortsatt intresse av att fortsätta använda systemet.
...
\paragraph{}
\hspace{-11}För den norska prototypen var syftet att stärka lokförarnas situationsmedvetenhet.
...
\paragraph{}
\hspace{-11}Båda projekten har olika syften och utvecklades oberoende av varandra men visar på gemensamma lärdomar och strategier.
