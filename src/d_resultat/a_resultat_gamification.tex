...
Den första fasen syftade till att synliggöra för förarna hur energieffektivt de körde genom att mäta hur mycket effekt från kontaktledningen som använts och återge detta så snabbt som möjligt.
...
Andra fasen syftade till att introducera gamification-moment där förarna kunde jämföra sig med varandra.
...
I tredje fasen låg fokus på att stärka förarnas intrinsiska motivation genom laganda och samarbete.
...
För fjärde och sista fasen låg fokus på att aktivera de bästa förarna på ett sätt så att de skulle få ett fortsatt intresse av att fortsätta använda systemet.
